...
public class PostMethod extends BaseUrl {
    ...
    public void postRequest() {
        ...
        placeHolder.setBirthdate("1970-01-01");
        placeHolder.setEmail("jdoe@fake.com");
        placeHolder.setPhone("8005555555");
        ...
        PlaceHolder expectedData = new PlaceHolder("John","Doe","1970-01-01",
